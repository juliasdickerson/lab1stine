...
int add_q31(int a, int b) {
    long fin = (long)a + (long)b; //help with overflow (back into 64 bits )
    int final = (int)fin; //back into 32 bit range 
    return final;
}
...
/*add_q31(int, int):
        ...
        assembly language for add couldnt find file 
        */

// Multiplly two Q1.31 fcan uxed point numbers
